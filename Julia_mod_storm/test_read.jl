...
# Manually Changes: B sizew jldname folder id
using JSON
using JLD
...
s = open("C:\\Users\\libow\\Desktop\\LANL_folder\\Julia_SOS1\\SOS1_14_single_run\\nf2_all.json") do file
    read(file, String)
end
...
save("14scenario2000.jld", "scenarior", scenarior,"ei",ei)
