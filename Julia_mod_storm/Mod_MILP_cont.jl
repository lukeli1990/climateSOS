...
aiwtsol=zeros(B,T,sizew) #aiwt for all iterations
...
@variable(m1st, 0<=aiwt[1:B,1:T,1:sizew]<=1) #sizew is indexed with scenario ascending order; relax as continuous
